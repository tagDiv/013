	...
	static function shortcode_to_args( $atts = '', $paged = '' ) {
		...
		extract( shortcode_atts(
				array(
					...
					'posts_per_page'              => '',
					//@todo se poate sa nu mai fie folosit
					'offset'                      => '',
					'live_filter'                 => '',
					'live_filter_cur_post_id'     => '',
					//this is auto generated by the block render ( add_live_filter_atts ) only when it's needed - it's the current post id
					'live_filter_cur_post_author' => ''
					//auto generated - author_id of current post
				),
				$atts
			)
		);
